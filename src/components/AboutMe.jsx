...
const aboutParagraphs = [
  {
    text: "👋 Yo! I'm Deepak Kumar Sahu — a passionate Full Stack Developer based in Hyderabad.",
    animation: { x: -30 }
  },
  {
  ...
  {
    text: "📚 Tech Stack: React, Spring Boot, MySQL, Git, REST APIs",
    animation: { x: 30 }
  },
  {
  ...
  return (
    <AppScreen title="About Me" onClose={onClose}>
      <div className="p-4 flex flex-col items-center space-y-4">
        ...
        <motion.img
          src="/deepak.jpg" // 🔁 change path if your image is somewhere else
